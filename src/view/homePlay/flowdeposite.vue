<template>
  <div class="deposite">
    <!--充值-->
    <div class="tel">
      <input type="number" name="tel" v-model="tel" key="flowdeposite"><span>通讯录</span>
    </div>
    <div class="price">
...
<script type="text/javascript">
  ...
  export default{
    data(){
      return {
        prices:[
          {price:30,price1:5,isred:true},
          {price:70,price1:10,isred:false},
          {price:150,price1:20,isred:false},
      ...
      add1(){
         ...
         if(this.tel===''){
          ...
          this.$store.state.tel=''
           this.$store.commit('changedepositetel',this.tel)
           this.$store.commit('changedepositeprice',this.pri)
